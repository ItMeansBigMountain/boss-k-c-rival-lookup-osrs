# BossKCRivalLookup Developer Cheat Sheet
...
```bash
cd ../../..
git add projects/osrs-plugins/BossKCRivalLookup
git commit -m "chore: update BossKCRivalLookup submodule"
git push origin main
```
